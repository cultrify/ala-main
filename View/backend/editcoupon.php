        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="chart.html" class="nav-item nav-link active"><i class="fa fa-dollar"></i>  Coupons</a>
                    <div class="nav-item dropdown">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form  method="get">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="IDCoupon" name="IDCoupon" value="<?php echo $coupon['IDCoupon']; ?>">
                                </div>
                                <div class="mb-3">
